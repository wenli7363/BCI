...
class EEGDataVisualizer(QWidget):
    ...
    def initUI(self):
        ...
        for i in self.channels_to_plot:
            ...
            plot_item.setTitle(f'Channel {i+1}', font=font)
    ...
    def set_visibility(self,plot_index,visible:bool):
        self.plots[plot_index].setVisible(visible)
        self.plot_items[plot_index].setVisible(visible)
